...
void Controller::start(debugTypes debug = NONE) // default debugmode er NONE
{
	...
	EIMSK |= (1 << INT4);				  // T�nd INT4

	// Bruger timer4 med
	// prescaler 1024
	// CTC mode.
	// til at aktivere en interrupt hvert minut til afl�sening af
	TCCR4A = 0;
	TCCR4B = 0;
...
void Controller::sendCommandToAllWindows(char command)
{
	...
	// Nedenst�ende implementering har nogle disadvantages.
